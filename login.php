      ...
      <div class="login-form">
        <?php
           if (isset($_GET['login']) && $_GET['login'] == 0) {
            print '<p style="color:red;background:#eee;text-align:center;">Oops! This credential does not match our records</p>';
          }else if (isset($_GET['logout']) && $_GET['logout'] == 1) {
                print '<p style="color:blue;background:#eee;text-align:center;">You have successfully logged out</p>';
            }
         ?>
